...
class TestTracingContext(BaseTestCase):
    ...
    def test_clone(self):
        ...
        assert cloned_ctx._active_span_id == ctx._active_span_id
        assert cloned_ctx._trace_id == ctx._trace_id
        assert cloned_ctx.sampling_priority == ctx.sampling_priority
